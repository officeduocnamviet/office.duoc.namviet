...
type Product struct {
	...
	PriceSell             *float64   `gorm:"type:numeric;default:0" json:"price_sell,omitempty"`
	UnitType              *string    `gorm:"type:text;default:'retail'" json:"unit_type,omitempty"`
	Price                 *float64   `gorm:"type:numeric;default:0" json:"price,omitempty"`
