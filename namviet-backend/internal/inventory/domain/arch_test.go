...
// ép ranh giới hexagon — package domain của inventory phải THUẦN, KHÔNG import hạ
...
func TestDomain_NoInfraImports(t *testing.T) {
	...
	forbidden := []string{
		...
		"github.com/Maneva-AI/namviet-backend/internal/inventory/app",      // không phụ thuộc ngược lên app
		"github.com/Maneva-AI/namviet-backend/internal/inventory/internal", // không phụ thuộc adapter
	}
