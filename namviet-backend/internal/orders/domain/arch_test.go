...
// ép ranh giới hexagon — package domain của orders phải THUẦN, KHÔNG import hạ
...
func TestDomain_NoInfraImports(t *testing.T) {
	...
	forbidden := []string{
		...
		"github.com/Maneva-AI/namviet-backend/internal/orders/app",      // không phụ thuộc ngược lên app
		"github.com/Maneva-AI/namviet-backend/internal/orders/internal", // không phụ thuộc adapter
	}
