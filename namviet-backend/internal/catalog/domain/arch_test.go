...
// ép ranh giới hexagon — package domain của catalog phải THUẦN, KHÔNG import hạ
...
func TestDomain_NoInfraImports(t *testing.T) {
	...
	forbidden := []string{
		...
		"github.com/Maneva-AI/namviet-backend/internal/catalog/app",      // không phụ thuộc ngược lên app
		"github.com/Maneva-AI/namviet-backend/internal/catalog/internal", // không phụ thuộc adapter
	}
