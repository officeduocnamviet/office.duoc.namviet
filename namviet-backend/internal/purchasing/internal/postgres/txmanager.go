...
// TxManager implement app.TxManager: mở một transaction qua platform/db.WithinTx rồi
// cấp pgx.Tx cho closure. Dùng cho mọi use-case GHI của purchasing (mỗi use-case =
// 1 transaction; cross-module nhận CÙNG tx → gộp atomic).
