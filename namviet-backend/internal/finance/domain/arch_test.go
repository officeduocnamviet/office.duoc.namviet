...
// ép ranh giới hexagon — package domain của finance phải THUẦN, KHÔNG import hạ
...
func TestDomain_NoInfraImports(t *testing.T) {
	...
	forbidden := []string{
		...
		"net/http",                      // HTTP
		"github.com/Maneva-AI/namviet-backend/internal/platform",         // adapter hạ tầng
		"github.com/Maneva-AI/namviet-backend/internal/finance/app",      // không phụ thuộc ngược app
		"github.com/Maneva-AI/namviet-backend/internal/finance/internal", // không phụ thuộc adapter
	}
